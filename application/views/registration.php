...
<body>
  <div class="form">
      ...
      <ul class="tab-group">
        <li class="tab <?php if(!isset($errors_log)){echo "active";} ?>"><a href="#signup">Sign Up</a></li>
        <li class="tab <?php if(isset($errors_log)){echo "active";} ?>"><a href="#login">Log In</a></li>
      </ul>
      ...
      <div class="tab-content">
        ...
        <div id="login" <?php if(isset($errors_log)){echo "style='display:block;'";} ?>>   
          ...
          <?php if(isset($errors_log)){ 
            echo"<p style='color:red;'>".$errors_log."</p>";
          } ?>
          </div>
