            ...
            <div class="row">
                ...
                <br>
							...
							{ 
								...
								echo "<p>".$post[$i]['message']."</p>"."<br>"."<p>"."Posted by"."<br>".$post[$i]['first_name']." ".$post[$i]['last_name']."</p>"."<br>"."<p>".$post[$i]['created_at']."</p>"."<br>";
                ...
                <div id="mystories-edit-box <?=$post[$i]['messages_id'];?>" style="display: none;">    
  								...
  								<form action="/index.php/Activity/update_post" method="post">
  									<textarea class="textarea text-area-mystory" name="title" placeholder="<?=$post[$i]['title'];?>" rows="1" cols="60%"></textarea><br>
  									<textarea class="textarea text-area-mystory" name="message" placeholder="<?=$post[$i]['message'];?>" rows="2" cols="60%"></textarea><br>							
                      ...
                      function myStoryCommentFunction(id) {
                        ...
                        if (x.style.display === 'none') {
							...
							<?php 
									...
									echo "<p>".$comments[$j]['comment']."</p>"."<br>";
									echo "<p>"."Commented by"."<br>".$comments[$j]['first_name']." ".$comments[$j]['last_name']."</p>"."<br>";
									echo "<p>".$comments[$j]['created_at']."</p>"."<br>";
									if( $comments[$j]['users_messages_id'] == $this->session->userdata('user_id')){
									?>
								<form action="/index.php/Activity/update_comment" method="post">
									<textarea class="textarea text-area-mystory" name="comment" placeholder="<?=$comments[$j]['comment'];?>" rows="1" cols="60%"></textarea><br>
